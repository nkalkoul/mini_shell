SRCS =	$(addprefix srcs/taken/, ft_initaken.c ft_parse_rd.c ft_taken_to_cmd.c) \
		...
		$(addprefix srcs/builtins/, ft_export.c ft_unset.c ft_echo.c ft_pwd.c ft_cd.c ft_do_bulding.c ft_exit.c) \
		$(addprefix srcs/garbage/, ft_garbage.c ft_garb_utils.c ft_garb_locks.c) \
		$(addprefix srcs/ast/, ft_ast.c tests_utils.c) \
		$(addprefix srcs/exec/, ft_exec.c ft_exec_utils.c ft_exec_is.c ft_redir.c ft_env2d.c ft_check_path.c)
